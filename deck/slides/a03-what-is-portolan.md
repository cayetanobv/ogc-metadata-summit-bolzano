...
<div class="def">
  <p>Portolan is an <span class="hl">open-source specification and toolkit</span> that combines <span class="hl">cloud-native file formats</span> with <span class="hl">clear metadata</span> and <span class="hl">documentation</span> so that <span class="hl">people and agents</span> can publish and use data <span class="hl">at any scale</span>.</p>
</div>
