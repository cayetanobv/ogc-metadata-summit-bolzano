...
const deckUrl = 'https://cayetanobv.github.io/ogc-metadata-summit-bolzano/#/18'
  ...
  <div class="stage">
    <svg class="canvas" viewBox="0 0 800 460" role="group" :data-print-ready="isPrintMode ? 'true' : 'false'"
      ...
      <a :href="deckUrl" target="_blank" rel="noopener noreferrer" class="svg-source-link"
        ...
        <text x="658" y="315" text-anchor="middle" class="deck-url">ogc-metadata-summit-bolzano/#/18</text>
